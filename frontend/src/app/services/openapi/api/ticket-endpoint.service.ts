...
// @ts-ignore
import { SectorTicketCreationRequest } from '../model/sector-ticket-creation-request';
// @ts-ignore
...
export class TicketEndpointService implements TicketEndpointServiceInterface {
     ...
     */
    public addSectionTicket(sectorTicketCreationRequest: SectorTicketCreationRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json;charset=UTF-8', context?: HttpContext, transferCache?: boolean}): Observable<TicketDetailsResponse>;
    public addSectionTicket(sectorTicketCreationRequest: SectorTicketCreationRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json;charset=UTF-8', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<TicketDetailsResponse>>;
    public addSectionTicket(sectorTicketCreationRequest: SectorTicketCreationRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json;charset=UTF-8', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<TicketDetailsResponse>>;
    public addSectionTicket(sectorTicketCreationRequest: SectorTicketCreationRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json;charset=UTF-8', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (sectorTicketCreationRequest === null || sectorTicketCreationRequest === undefined) {
            throw new Error('Required parameter sectorTicketCreationRequest was null or undefined when calling addSectionTicket.');
        }
