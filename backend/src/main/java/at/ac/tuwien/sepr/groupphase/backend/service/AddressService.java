...
public interface AddressService {
     ...
     */
    AddressDto update(AddressDto addressDto) throws ValidationException, EntityNotFoundException, ForbiddenException;
     ...
     */
    AddressDto findById(Long id) throws EntityNotFoundException;
