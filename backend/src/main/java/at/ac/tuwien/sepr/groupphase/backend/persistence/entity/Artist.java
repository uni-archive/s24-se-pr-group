...
public class Artist extends AbstractEntity {
    ...
    @ManyToMany
    @JoinTable(name = "ARTIST_SHOW", joinColumns = @JoinColumn(name = "ARTIST_ID"), inverseJoinColumns = @JoinColumn(name = "SHOW_ID"))
    ...
    public String toString() {
        return "Artist{" + "artistName='" + artistName + '\'' + ", firstName='" + firstName + '\'' + ", lastName='" + lastName + '\'' + ", shows=" + shows + '}';
    }
